...
if __name__ == "__main__":
    ...
    print("Drop columns with missing values:\t", score_dataset(reduced_X_train, reduced_X_valid, y_train, y_valid))
    ...
    print("Imputation:\t\t\t\t", score_dataset(imputed_X_train, imputed_X_valid, y_train, y_valid))
    ...
    print("An Extension to Imputation:\t\t", score_dataset(imputed_X_train_plus, imputed_X_valid_plus, y_train, y_valid))
